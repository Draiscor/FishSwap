...
* **Safety First:** Before un-equipping your weapons, FishSwap checks if you have enough free bag space (at least 2 slots) to safely store your current gear. If your bags are too full, it aborts the swap to prevent items from getting stuck on your cursor or lost.
...
| Action | Function |
| :--- | :--- |
| **Left Click** | **Toggle Gear.** <br> 1. Saves current weapons & equips best Fishing Pole.<br> 2. Clicks again to re-equip the saved weapons. |
...
FishSwap uses a **Visual Tooltip Scan** rather than `GetItemInfo` to detect fishing poles. This ensures 100% reliability on private server clients where item cache data can sometimes be delayed or missing.

## License

Open Source. Feel free to modify or include in addon packs.
